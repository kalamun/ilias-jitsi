...
/**
 * Class ilJitsiConfigGUI
 * 
 * @ilCtrl_IsCalledBy ilJitsiConfigGUI: ilObjComponentSettingsGUI
 *
 ...
 */
class ilJitsiConfigGUI extends ilPluginConfigGUI
{
    ...
    protected function setTabs()/*: void*/
    {
        ...
        self::dic()->locator()->addItem(ilJitsiPlugin::PLUGIN_NAME, self::dic()->ctrl()->getLinkTarget($this, self::CMD_CONFIGURE));
    }
    ...
    protected function configure()/*: void*/
    {
        ...
        $form = self::jitsi()->config()->factory()->newFormInstance($this);
